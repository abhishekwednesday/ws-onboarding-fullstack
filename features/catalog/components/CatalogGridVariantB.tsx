      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            {/* Actions */}
            <div
              className="flex items-center gap-2 pr-2 opacity-100 transition-opacity duration-300 lg:opacity-0 lg:group-focus-within:opacity-100 lg:group-hover:opacity-100"
