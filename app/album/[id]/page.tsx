        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end">
          ...
          <div className="flex flex-1 flex-col space-y-4">
            ...
            <div className="flex items-center gap-4 pt-4">
              <button className="bg-primary text-primary-foreground flex h-14 items-center gap-2 rounded-2xl px-8 font-bold transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(var(--primary),0.3)] active:scale-95">
