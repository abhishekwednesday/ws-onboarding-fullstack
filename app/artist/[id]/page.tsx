            ...
            <div className="space-y-10 py-10">
                ...
                <div className="space-y-8">
                    <div className="flex flex-col gap-6 md:flex-row md:items-center">
                        <div className="relative h-48 w-48 overflow-hidden rounded-3xl border border-border/50 bg-background/40 shadow-xl backdrop-blur-md">
                        ...
                        <div className="space-y-2">
                            ...
                            <h1 className="font-serif text-5xl font-bold tracking-tight sm:text-7xl text-foreground">
                                {artist.artist}
                            </h1>
                ...
                <div className="border-t border-border/40 pt-10">
                    <h2 className="mb-8 font-serif text-2xl font-bold text-foreground">Albums</h2>
                    {albums.length > 0 ? (
                        ...
                        <div className="flex min-h-[200px] flex-col items-center justify-center rounded-3xl border border-border/10 bg-background/20 py-10 text-center">
